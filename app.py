...
def send_email_sendgrid(to_email, subject, html_content):
    ...
    message = SendGridMail(
        from_email=(os.getenv('SENDGRID_FROM_EMAIL'), os.getenv('SENDGRID_FROM_NAME', 'Geboy Mujair')),
        to_emails=to_email,
        subject=subject,
...
def send_email_gmail(to_email, subject, html_content):
    """Send email using Gmail SMTP (Flask-Mail)"""
    try:
        msg = Message(
            subject=subject,
            recipients=[to_email],
        ...
        mail.send(msg)
        print(f"✅ Gmail email sent!")
        return True
    except Exception as e:
        print(f"❌ Gmail error: {e}")
        return False

def send_email(to_email, subject, html_content, provider='sendgrid'):
    """
...
def generate_kasir_pos():
    """
    Generate halaman Point of Sale (POS) untuk kasir dengan gambar produk.
    """
    username = session.get('username', 'User')
    ...
    <body>
        <div class="dashboard-container">
            ...
            <div class="main-content">
                ...
                <div class="pos-grid">
                    <!-- Kolom Kiri: Input Produk dengan Gambar -->
                    <div class="content-section">
                        <h2>Tambah Item</h2>
                        
                        <!-- Gambar Produk -->
                        <div class="product-image-container">
                            <img src="/static/images/mujair.png" alt="Ikan Mujair" class="product-image">
                            <div class="product-name">🐟 Ikan Mujair Segar</div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="productQty" step="0.1" value="1" min="0.1">
                            </div>
                            <div class="form-group">
        ...
        <script>
            ...
            function renderCart() {{
                ...
                if (cart.length === 0) {{
                    ...
                    cartTotalEl.innerHTML = formatRupiah(0);
                    return;
                }}
...
def register():
    if request.method == 'POST':
        ...
        try:
            send_email(email, 'Verifikasi Email Geboy Mujair', html, provider='sendgrid')
...
def forgot_password():
    if request.method == 'POST':
        ...
        try:
            send_email(email, 'Reset Password Geboy Mujair', html, provider='sendgrid')
